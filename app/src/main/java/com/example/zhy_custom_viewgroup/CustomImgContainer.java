...
public class CustomImgContainer extends FrameLayout {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    cl = getWidth() - childView.getMeasuredWidth() - cParams.leftMargin
                            - cParams.rightMargin;
                    ct = cParams.topMargin;
                ...
                case 2:
                    cl = cParams.leftMargin;
                    ct = getHeight() - childView.getMeasuredWidth() - cParams.bottomMargin;
                    break;
                case 3:
                    cl = getWidth() - childView.getMeasuredWidth() - cParams.leftMargin
                            - cParams.rightMargin;
                    ct = getHeight() - childView.getMeasuredHeight() - cParams.bottomMargin;
                    break;
